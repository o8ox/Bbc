...
client.once("ready", () => {
  ...
  console.log("Code by 3.991");
  console.log("discord.gg/sxrUcb8C8A");
  client.user.setActivity(`ASTRA`);
    ...
    const help = new EmbedBuilder()
      ...
      .setDescription(`**__Commands__**  
          ...
          **BroadCast Cmds**
          ...
          ـــــــــــــــــــــــــ
          By : zai
          ASTRA **|** [**Support Server**](discord.gg/sxrUcb8C8A)`);
...
client.on("messageCreate", msg => {
  if (msg.content === `${prefix}support`) {
    msg.reply("https://discord.gg/sxrUcb8C8A");
  }
});
